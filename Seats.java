...
public class Seats extends javax.swing.JFrame {
    ...
    static String d;
     ...
     boolean b1=false,b2=false,b3=false,b4=false,b5=false,b6=false,b7=false,b8=false,b9=false,b10=false,b11=false;
    public Seats(String p) {
        initComponents();
        d=p;
       jLabel2.setText(d);
       //add(jLabel2);       
    ...
    private void jButton12ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton12ActionPerformed
        // TODO add your handling code here:
       System.out.println("no.of seats booked="+b);
       if(b1==true)
       {
           Ticket t1=new Ticket(d,1);
           //t1.seatno(d,1);
       }
       if(b2==true)
       {
          Ticket t1=new Ticket(d,2);
          // t1.seatno(d,2);
       }
        if(b3==true)
       {
           Ticket t1=new Ticket(d,3);
           //t1.seatno(d,3);
       }
        if(b4==true)
       {
           Ticket t1=new Ticket(d,4);
           //t1.seatno(d,4);
       }
        if(b5==true)
       {
         Ticket t1=new Ticket(d,5);
           //t1.seatno(d,5);
       }
        if(b6==true)
       {
           Ticket t1=new Ticket(d,6);
           //t1.seatno(d,6);
       }
        if(b7==true)
       {
          Ticket t1=new Ticket(d,7);
           //t1.seatno(d,7);
       }
        if(b8==true)
       {
           Ticket t1=new Ticket(d,8);
          // t1.seatno(d,8);
       }
        if(b9==true)
       {
         Ticket t1=new Ticket(d,9);
           //t1.seatno(d,9);
       }
        if(b10==true)
       {
           Ticket t1=new Ticket(d,10);
           //t1.seatno(d,10);
       }
        if(b11==true)
       {
           Ticket t1=new Ticket(d,11);
          // t1.seatno(d,11);
       }
